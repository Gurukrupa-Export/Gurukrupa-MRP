...
def get_platinum_price():
	...
	url = f"https://in.investing.com/currencies/xpt-usd-historical-data?end_date={end_date_epoch}&st_date={start_date_epoch}"
	...
	'referer': 'https://in.investing.com/currencies/xpt-usd-historical-data?end_date=1685471400&st_date=1682879400',
	'res-scheme': '1',
